...
usage()
{
  echo "Merge Histograms Script.  @@VERSION@@

$0 <inputs> <output txt file> <optional arguments>
  inputs            Directory with *.txt text histogram text files
  output txt file   ASCII text file containing merged histogram of pixel
                    intensities.  
...
$SOURCE/merge_histograms "${INPUT}" "${OUTPUT}";
